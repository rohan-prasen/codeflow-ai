...
const testimonials = [
  {
    ...
    content:
      "This platform is a game-changer! It has significantly improved my productivity and workflow. Highly recommended!",
  },

  {
    ...
    content:
      "The intuitive design and user-friendly interface make it easy to navigate. It has become an essential tool for my team.",
  },

  {
    ...
    content:
      "I love how customizable the features are. It allows me to tailor the experience to my specific needs, enhancing my overall efficiency.",
  },
];
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="lg:w-1/2 w-full text-center lg:text-left">
            ...
            <p className="text-gray-400 text-base text-xl sm:text-lg max-w-2xl mx-auto">
              Everything you need to build, test and deploy your application
