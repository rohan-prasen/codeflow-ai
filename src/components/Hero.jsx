      ...
      <div className="max-w-7xl mx-auto text-center relative w-full">
        <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 text-center lg:text-left gap-6 sm:gap-8 lg:gap-12 items-center relative">
          <div>
            ...
            <p className="text-md md:text-base lg:text-lg text-gray-400 max-w-2xl mx-auto lg:mx-0 mb-6 sm:mb-8 animate-in slide-in-from-bottom duration-700 delay-200 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justfy-center lg:justify-start gap-3 sm:gap-3 sm:gap-4 mb-8 sm:mb-12 animate-in slide-in-from-bottom duration-700 delay-300">
              <button className="group w-full sm:w-auto px-4 sm:px-8 py-3 sm:py-4 bg-gradient-to-b from-blue-600 to to-blue-400 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 hover:scale-102 flex items-center justify-center space-x-2">
                <span>Start Coding For Free</span>
                <ArrowRight className="w-4 h-4 sm:w-4 sm:h-5 group-hover:translate-x-1 transition-trnasform duration-300"/>
              </button>
              ...
              <button className="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 hover:bg-white/10 flex items-center justify-center space-x-2">
                <div className="p-2 bg-white/10 rounded-full group-hover:bg-white/20 duration-300 transition-colors">
                  <Play className="w-4 h-4 sm:w-4 sm:h-5 fill-white"/>
                </div>
                ...
                <div className="flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3 bg-white/5 backdrop-blur-sm border-b border-white/10">
                  <div className="flex items-center sm:space-x-2">
                    <div className="flex items-center space-x-1 sm:space-x-2">
                      <div className="w-2 h-2 sm:w-3 h-3 rounded-full bg-red-500" />
                      <div className="w-2 h-2 sm:w-3 h-3 rounded-full bg-yellow-500" />
                      <div className="w-2 h-2 sm:w-3 h-3 rounded-full bg-green-500" />
                    </div>
                ...
                <div className="p-3 sm:p-4 relative h-full">
                  ...
                  <div className="flex space-x-1 sm:space-x-2 mb-3 sm:mb-4 overflow-x-auto">
                    <button
                      ...
                      className={`px-3 py-2 backdrop-blur-sm text-sx text-sm rounded-t-lg border ${
                        activeTab === "App.jsx"
                  ...
                  <div
                    key={activeTab}
                    className="relative overflow-hidden flex-grow animate-in slide-in-from-top delay-100 duration-200 ease-out"
                  >
                    <SyntaxHighlighter
                      language="javascript"
                      style={nightOwl}
