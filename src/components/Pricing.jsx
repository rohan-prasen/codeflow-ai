          ...
          {plans.map((plan, key) => (
            ...
            >
              <div className="absolute inset-0 pointer-events-none rounded-xl sm:rounded-2xl overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-transparent opacity-0  group-hover:opacity-100 transition-opacity duration-500 transform -translate-x-full translate-y-full group-hover:translate-x-0 group-hover:translate-y-0 pointer-events-none rounded-lg overflow-hidden"></div>
              </div>
              {plan.mostPopular && (
              ...
              <div className="text-center mb-6 sm:mb-8">
                ...
                <div className="flex items-baseline justify-center">
                  ...
                  <span className="textt-gray-400 ml-1 sm:m-2 text-sm sm:text-base">
                    /month
                  </span>
                </div>
              </div>

              <ul className="space-y-3 sm:space-y-4 mb-6 sm:mg-8 flex-row">
              ...
              <button
                className={`w-full py-2.5 sm:3 px-4 sm:px-4 rounded-lg font-semibold transition-all duration-300 mt-auto hover:scale-102 cursor-pointer text-sm sm:text-base
                ${
                  plan.mostPopular
